...
// Generated from Mojang vanilla assets minecraft/sounds.json.
// Minecraft version: 1.21.11
// sounds.json hash: 123370fbb15bf1e85cf5038b3e8ca719ad391dfb
// Generated at (UTC): 2026-03-06T08:25:27.110137+00:00
enum class Sound(val key: String) {
    ...
    BLOCK_COPPER_CHEST_CLOSE("minecraft:block.copper_chest.close"),
    BLOCK_COPPER_CHEST_OPEN("minecraft:block.copper_chest.open"),
    BLOCK_COPPER_CHEST_OXIDIZED_CLOSE("minecraft:block.copper_chest_oxidized.close"),
    BLOCK_COPPER_CHEST_OXIDIZED_OPEN("minecraft:block.copper_chest_oxidized.open"),
    BLOCK_COPPER_CHEST_WEATHERED_CLOSE("minecraft:block.copper_chest_weathered.close"),
    BLOCK_COPPER_CHEST_WEATHERED_OPEN("minecraft:block.copper_chest_weathered.open"),
    BLOCK_COPPER_DOOR_CLOSE("minecraft:block.copper_door.close"),
    BLOCK_COPPER_DOOR_OPEN("minecraft:block.copper_door.open"),
    BLOCK_COPPER_GOLEM_STATUE_BREAK("minecraft:block.copper_golem_statue.break"),
    BLOCK_COPPER_GOLEM_STATUE_FALL("minecraft:block.copper_golem_statue.fall"),
    BLOCK_COPPER_GOLEM_STATUE_HIT("minecraft:block.copper_golem_statue.hit"),
    BLOCK_COPPER_GOLEM_STATUE_PLACE("minecraft:block.copper_golem_statue.place"),
    BLOCK_COPPER_GOLEM_STATUE_STEP("minecraft:block.copper_golem_statue.step"),
    ...
    BLOCK_SHELF_ACTIVATE("minecraft:block.shelf.activate"),
    BLOCK_SHELF_BREAK("minecraft:block.shelf.break"),
    BLOCK_SHELF_DEACTIVATE("minecraft:block.shelf.deactivate"),
    BLOCK_SHELF_FALL("minecraft:block.shelf.fall"),
    BLOCK_SHELF_HIT("minecraft:block.shelf.hit"),
    BLOCK_SHELF_MULTI_SWAP("minecraft:block.shelf.multi_swap"),
    BLOCK_SHELF_PLACE("minecraft:block.shelf.place"),
    BLOCK_SHELF_PLACE_ITEM("minecraft:block.shelf.place_item"),
    BLOCK_SHELF_SINGLE_SWAP("minecraft:block.shelf.single_swap"),
    BLOCK_SHELF_STEP("minecraft:block.shelf.step"),
    BLOCK_SHELF_TAKE_ITEM("minecraft:block.shelf.take_item"),
    ...
    ENTITY_BABY_NAUTILUS_AMBIENT("minecraft:entity.baby_nautilus.ambient"),
    ENTITY_BABY_NAUTILUS_AMBIENT_LAND("minecraft:entity.baby_nautilus.ambient_land"),
    ENTITY_BABY_NAUTILUS_DEATH("minecraft:entity.baby_nautilus.death"),
    ENTITY_BABY_NAUTILUS_DEATH_LAND("minecraft:entity.baby_nautilus.death_land"),
    ENTITY_BABY_NAUTILUS_EAT("minecraft:entity.baby_nautilus.eat"),
    ENTITY_BABY_NAUTILUS_HURT("minecraft:entity.baby_nautilus.hurt"),
    ENTITY_BABY_NAUTILUS_HURT_LAND("minecraft:entity.baby_nautilus.hurt_land"),
    ENTITY_BABY_NAUTILUS_SWIM("minecraft:entity.baby_nautilus.swim"),
    ...
    ENTITY_CAMEL_HUSK_AMBIENT("minecraft:entity.camel_husk.ambient"),
    ENTITY_CAMEL_HUSK_DASH("minecraft:entity.camel_husk.dash"),
    ENTITY_CAMEL_HUSK_DASH_READY("minecraft:entity.camel_husk.dash_ready"),
    ENTITY_CAMEL_HUSK_DEATH("minecraft:entity.camel_husk.death"),
    ENTITY_CAMEL_HUSK_EAT("minecraft:entity.camel_husk.eat"),
    ENTITY_CAMEL_HUSK_HURT("minecraft:entity.camel_husk.hurt"),
    ENTITY_CAMEL_HUSK_SADDLE("minecraft:entity.camel_husk.saddle"),
    ENTITY_CAMEL_HUSK_SIT("minecraft:entity.camel_husk.sit"),
    ENTITY_CAMEL_HUSK_STAND("minecraft:entity.camel_husk.stand"),
    ENTITY_CAMEL_HUSK_STEP("minecraft:entity.camel_husk.step"),
    ENTITY_CAMEL_HUSK_STEP_SAND("minecraft:entity.camel_husk.step_sand"),
    ...
    ENTITY_COPPER_GOLEM_DEATH("minecraft:entity.copper_golem.death"),
    ENTITY_COPPER_GOLEM_HURT("minecraft:entity.copper_golem.hurt"),
    ENTITY_COPPER_GOLEM_ITEM_DROP("minecraft:entity.copper_golem.item_drop"),
    ENTITY_COPPER_GOLEM_ITEM_NO_DROP("minecraft:entity.copper_golem.item_no_drop"),
    ENTITY_COPPER_GOLEM_NO_ITEM_GET("minecraft:entity.copper_golem.no_item_get"),
    ENTITY_COPPER_GOLEM_NO_ITEM_NO_GET("minecraft:entity.copper_golem.no_item_no_get"),
    ENTITY_COPPER_GOLEM_SHEAR("minecraft:entity.copper_golem.shear"),
    ENTITY_COPPER_GOLEM_SPAWN("minecraft:entity.copper_golem.spawn"),
    ENTITY_COPPER_GOLEM_SPIN("minecraft:entity.copper_golem.spin"),
    ENTITY_COPPER_GOLEM_STEP("minecraft:entity.copper_golem.step"),
    ENTITY_COPPER_GOLEM_BECOME_STATUE("minecraft:entity.copper_golem_become_statue"),
    ENTITY_COPPER_GOLEM_OXIDIZED_DEATH("minecraft:entity.copper_golem_oxidized.death"),
    ENTITY_COPPER_GOLEM_OXIDIZED_HURT("minecraft:entity.copper_golem_oxidized.hurt"),
    ENTITY_COPPER_GOLEM_OXIDIZED_SPIN("minecraft:entity.copper_golem_oxidized.spin"),
    ENTITY_COPPER_GOLEM_OXIDIZED_STEP("minecraft:entity.copper_golem_oxidized.step"),
    ENTITY_COPPER_GOLEM_WEATHERED_DEATH("minecraft:entity.copper_golem_weathered.death"),
    ENTITY_COPPER_GOLEM_WEATHERED_HURT("minecraft:entity.copper_golem_weathered.hurt"),
    ENTITY_COPPER_GOLEM_WEATHERED_SPIN("minecraft:entity.copper_golem_weathered.spin"),
    ENTITY_COPPER_GOLEM_WEATHERED_STEP("minecraft:entity.copper_golem_weathered.step"),
    ...
    ENTITY_NAUTILUS_AMBIENT("minecraft:entity.nautilus.ambient"),
    ENTITY_NAUTILUS_AMBIENT_LAND("minecraft:entity.nautilus.ambient_land"),
    ENTITY_NAUTILUS_DASH("minecraft:entity.nautilus.dash"),
    ENTITY_NAUTILUS_DASH_LAND("minecraft:entity.nautilus.dash_land"),
    ENTITY_NAUTILUS_DASH_READY("minecraft:entity.nautilus.dash_ready"),
    ENTITY_NAUTILUS_DASH_READY_LAND("minecraft:entity.nautilus.dash_ready_land"),
    ENTITY_NAUTILUS_DEATH("minecraft:entity.nautilus.death"),
    ENTITY_NAUTILUS_DEATH_LAND("minecraft:entity.nautilus.death_land"),
    ENTITY_NAUTILUS_EAT("minecraft:entity.nautilus.eat"),
    ENTITY_NAUTILUS_HURT("minecraft:entity.nautilus.hurt"),
    ENTITY_NAUTILUS_HURT_LAND("minecraft:entity.nautilus.hurt_land"),
    ENTITY_NAUTILUS_RIDING("minecraft:entity.nautilus.riding"),
    ENTITY_NAUTILUS_SWIM("minecraft:entity.nautilus.swim"),
    ...
    ENTITY_PARCHED_AMBIENT("minecraft:entity.parched.ambient"),
    ENTITY_PARCHED_DEATH("minecraft:entity.parched.death"),
    ENTITY_PARCHED_HURT("minecraft:entity.parched.hurt"),
    ENTITY_PARCHED_STEP("minecraft:entity.parched.step"),
    ...
    ENTITY_PARROT_IMITATE_CAMEL_HUSK("minecraft:entity.parrot.imitate.camel_husk"),
    ...
    ENTITY_PARROT_IMITATE_PARCHED("minecraft:entity.parrot.imitate.parched"),
    ...
    ENTITY_PARROT_IMITATE_ZOMBIE_HORSE("minecraft:entity.parrot.imitate.zombie_horse"),
    ENTITY_PARROT_IMITATE_ZOMBIE_NAUTILUS("minecraft:entity.parrot.imitate.zombie_nautilus"),
    ...
    ENTITY_ZOMBIE_HORSE_ANGRY("minecraft:entity.zombie_horse.angry"),
    ENTITY_ZOMBIE_HORSE_DEATH("minecraft:entity.zombie_horse.death"),
    ENTITY_ZOMBIE_HORSE_EAT("minecraft:entity.zombie_horse.eat"),
    ENTITY_ZOMBIE_HORSE_HURT("minecraft:entity.zombie_horse.hurt"),
    ENTITY_ZOMBIE_NAUTILUS_AMBIENT("minecraft:entity.zombie_nautilus.ambient"),
    ENTITY_ZOMBIE_NAUTILUS_AMBIENT_LAND("minecraft:entity.zombie_nautilus.ambient_land"),
    ENTITY_ZOMBIE_NAUTILUS_DASH("minecraft:entity.zombie_nautilus.dash"),
    ENTITY_ZOMBIE_NAUTILUS_DASH_LAND("minecraft:entity.zombie_nautilus.dash_land"),
    ENTITY_ZOMBIE_NAUTILUS_DASH_READY("minecraft:entity.zombie_nautilus.dash_ready"),
    ENTITY_ZOMBIE_NAUTILUS_DASH_READY_LAND("minecraft:entity.zombie_nautilus.dash_ready_land"),
    ENTITY_ZOMBIE_NAUTILUS_DEATH("minecraft:entity.zombie_nautilus.death"),
    ENTITY_ZOMBIE_NAUTILUS_DEATH_LAND("minecraft:entity.zombie_nautilus.death_land"),
    ENTITY_ZOMBIE_NAUTILUS_EAT("minecraft:entity.zombie_nautilus.eat"),
    ENTITY_ZOMBIE_NAUTILUS_HURT("minecraft:entity.zombie_nautilus.hurt"),
    ENTITY_ZOMBIE_NAUTILUS_HURT_LAND("minecraft:entity.zombie_nautilus.hurt_land"),
    ENTITY_ZOMBIE_NAUTILUS_SWIM("minecraft:entity.zombie_nautilus.swim"),
    ...
    ITEM_ARMOR_EQUIP_COPPER("minecraft:item.armor.equip_copper"),
    ...
    ITEM_ARMOR_EQUIP_NAUTILUS("minecraft:item.armor.equip_nautilus"),
    ...
    ITEM_ARMOR_UNEQUIP_NAUTILUS("minecraft:item.armor.unequip_nautilus"),
    ...
    ITEM_NAUTILUS_SADDLE_EQUIP("minecraft:item.nautilus_saddle_equip"),
    ITEM_NAUTILUS_SADDLE_UNDERWATER_EQUIP("minecraft:item.nautilus_saddle_underwater_equip"),
    ...
    ITEM_SPEAR_ATTACK("minecraft:item.spear.attack"),
    ITEM_SPEAR_HIT("minecraft:item.spear.hit"),
    ITEM_SPEAR_LUNGE_1("minecraft:item.spear.lunge_1"),
    ITEM_SPEAR_LUNGE_2("minecraft:item.spear.lunge_2"),
    ITEM_SPEAR_LUNGE_3("minecraft:item.spear.lunge_3"),
    ITEM_SPEAR_USE("minecraft:item.spear.use"),
    ITEM_SPEAR_WOOD_ATTACK("minecraft:item.spear_wood.attack"),
    ITEM_SPEAR_WOOD_HIT("minecraft:item.spear_wood.hit"),
    ITEM_SPEAR_WOOD_USE("minecraft:item.spear_wood.use"),
    ...
    WEATHER_END_FLASH("minecraft:weather.end_flash"),
    WEATHER_RAIN("minecraft:weather.rain"),
    WEATHER_RAIN_ABOVE("minecraft:weather.rain.above");

    companion object {
        private val byKey: Map<String, Sound> = entries.associateBy { normalizeKey(it.key) }

        val DEFAULT: Sound = fromKey("minecraft:ui.button.click") ?: entries.first()

        fun fromKey(key: String): Sound? = byKey[normalizeKey(key)]
